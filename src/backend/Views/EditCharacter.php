            ...
            <div class="col-md-6 offset-md-3">
                <form action="<?php echo URL_AUTH_Profile . "/Characters/Edit/treatment" ?>" method="POST">
                    ...
                    <select class="form-control" id="classe" name="classe">
                        <option value="<?php echo $class['id']; ?>"><?php echo $_SESSION['detailsCharacter']['name_class'] . ' ' . $_SESSION['detailsCharacter']    ['name_spec']; ?></option>
                    ...
                    <div class="button-container">
                        ...
                        <a class="button-red" href="<?php echo URL_AUTH_Profile . "/Character/Details?id=" . $_SESSION['detailsCharacter']['id']; ?>">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
